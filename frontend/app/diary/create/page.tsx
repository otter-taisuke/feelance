        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
          <div className="animate-fade-in">
            <div className="flex flex-col items-center gap-3 bg-white rounded-lg shadow-lg p-6 border-2 border-blue-200 max-w-md">
              <HappyChan size="large" variant={getHappyChanVariant(transaction.mood_score)} />
              <p className="text-lg font-bold text-blue-600 text-center">{getMessage(transaction.mood_score)}</p>
            </div>
          </div>
        </div>
      )}
