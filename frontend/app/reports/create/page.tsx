          ...
          <div className="rounded-lg bg-white p-4 shadow-sm space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 text-xs text-zinc-500">
                <span>AI生成</span>
                <button
                  className="rounded border border-zinc-300 px-2 py-1 text-xs hover:border-zinc-500 disabled:opacity-50"
            ...
            <label className="block text-sm font-medium text-zinc-700">
              本文
              <textarea
                className="mt-1 h-48 w-full rounded border border-zinc-300 p-2"
                value={reportBody}
